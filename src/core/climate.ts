...
export const CLIMATE_LINKS: ClimateLink[] = [
  {
    ...
    body:
      "El Niño and La Niña are a natural Pacific cycle — carbon doesn't trigger them. But each year's CO₂ adds to a warmer ocean and atmosphere, so when an El Niño arrives it pushes record heat and marine heatwaves from an already-raised floor. Models also project stronger swings as warming continues.",
  ...
  },
  {
    ...
    body:
      "A warmer atmosphere holds ~7% more moisture per °C, which loads the monsoon toward fewer-but-fiercer downpours and longer dry spells between them. El Niño years already tend to suppress monsoon rain — warming sharpens the variability farmers feel.",
    source: { label: "IPCC AR6 — Regional (South Asia)", url: "https://www.ipcc.ch/report/ar6/wg1/" },
  },
  {
    id: "heat",
    ico: "🔥",
    ...
    body:
      "Heatwaves that were rare are now routine, and they ride higher during El Niño years. The link to cumulative CO₂ is direct and well-measured — this is the anomaly your geyser, AC and idling clues touch most.",
  ...
  },
  {
    ...
    body:
      "The sea has absorbed the vast majority of the extra heat from greenhouse gases. Warmer water feeds stronger cyclones in the Arabian Sea and Bay of Bengal and bleaches reefs — long-lived CO₂ keeps that heat banked for centuries.",
